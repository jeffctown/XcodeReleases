...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_jlett/21158a2ba20af3193acc7421510224c0/execroot/__main__',
    'ios_x86_64',
    {
        'ios_i386': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/jlett/Library/Application Support/Tulsi/0.20190710.88/Bazel',
